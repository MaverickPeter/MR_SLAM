...
def detect_loop_icp(robotid_current, idx_current, pc_current, RING_current, TIRING_current, \
...
def callback1(data):
    ...
    # robotid_candidate = 0
    # detect_loop_icp(robotid_current, idx_current, pc, pc_RING, pc_TIRING, robotid_candidate, PC1, RING1, TIRING1)
    # candidate robot id: 2
    robotid_candidate = 1
    detect_loop_icp(robotid_current, idx_current, pc, pc_RING, pc_TIRING, robotid_candidate, PC2, RING2, TIRING2)
    # candidate robot id: 3
    robotid_candidate = 2
    detect_loop_icp(robotid_current, idx_current, pc, pc_RING, pc_TIRING, robotid_candidate, PC3, RING3, TIRING3)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dist_threshold', type=float, default=0.50) # 0.48 is usually safe (for avoiding false loop closure)
