...
if __name__ == "__main__":
    ...
    cfg.LOG_DIR = '/home/client/Mapping_ws/src/disco_ros/log/polar_both_40_120_20/'
    #polar_density_both_40_120_20/'
    ...
    pub = rospy.Publisher('/robot_1/disco', DiSCO, queue_size=10)
    rospy.Subscriber("/robot_1/submap", SubMap, callback)
    rospy.spin()
